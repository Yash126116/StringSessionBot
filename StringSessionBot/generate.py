...
async def generate_session(bot: Client, msg: Message, telethon=False, is_bot: bool = False):
    ...
    text = f"**{ty.upper()} STRING SESSION** \n\n`{string_session}` \n\nGenerated by @Session_Generation_bot"
